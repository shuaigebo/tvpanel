...
$obj=(Object)null;
$region=$province;
if($province == '' && $city == '') {$region=$country;}
if($province == $city) {$region=$country;}
if(empty($province)) {$region=$area;$city=$country;}
if(empty($city)) {$region=$country;$city=$province;}
if(empty($isp)) {$region=$area;$city='';$isp=$country;}
